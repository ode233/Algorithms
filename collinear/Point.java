...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            point = new Point(Integer.parseInt(StdIn.readString()),
                              Integer.parseInt(StdIn.readString()));
            point.draw();
        }
        point = new Point(14000, 20000);
        point.drawTo(new Point(32000, 20000));
        System.out.println(point.compareTo(new Point(10000, 20000)));
        System.out.println(point.slopeOrder()
                                .compare(new Point(14000, 30000), new Point(14000, 20000)));
    }
}
